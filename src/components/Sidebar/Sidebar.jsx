...
const Sidebar = () => {
    ...
    return (
        <div className=' inline-flex flex-col justify-between min-h-[100vh] bg-[#f0f4f9] px-3 py-6'>
            <div>
                <Menu onClick={() => setExtended(prev => !prev)} size={20} className=' block ml-4 cursor-pointer' />
                ...
                {extended
                    ...
                    <div className=' flex flex-col'>
                        ...
                        <div className=' flex items-start gap-2 px-4 py-3 rounded-full text-[#282828] cursor-pointer hover:bg-[#e2e6eb]'>
                            <MessageSquare />
                            <p>What is React ...</p>
                        </div>
                    </div>
